...
<body class="ps-loading">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="header__actions">
                            @auth
                            <a href="{{ route('signout') }}">{{ Auth::user()->name }} | {{ __('Logout') }}</a>
                            @else
                            <a href="{{ route('login') }}">{{ __('Login & Regiser') }}</a>
                            @endauth
    ...
    <main class="ps-main">
        @yield('content')
        <div class="ps-footer bg--cover" data-background="{{ asset('front-assets/images/background/parallax.jpg') }}">
                ...
                <div class="ps-container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                            <p>&copy; <a href="#">{{ config('app.name') }}</a>, Inc. All rights Resevered.</p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                            <ul class="ps-social">
