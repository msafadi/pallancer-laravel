              ...
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  <div class="ps-product__variants">
                    ...
                    <div class="item"><img src="{{ asset('images/' . $image->path) }}" alt=""></div>
                    @endforeach
                ...
                @foreach($product->images as $image)
                  <div class="item"><img class="zoom" src="{{ asset('images/' . $image->path) }}" alt="" data-zoom-image="images/shoe-detail/1.jpg"></div>
                  @endforeach
                </div>
              </div>
              <div class="ps-product__thumbnail--mobile">
                <div class="ps-product__main-img"><img src="{{ asset('images/' . $product->image) }}" alt=""></div>
